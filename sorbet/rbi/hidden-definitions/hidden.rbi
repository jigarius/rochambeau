...
module Rochambeau::Player
  def choose_option(*args, &blk); end

  def input_choice(*args, &blk); end

  def name(*args, &blk); end

  def victory_message(*args, &blk); end
end

class Rochambeau::Player::NamedHuman
  include ::Rochambeau::Player
...
class Rochambeau::Player::UnnamedHuman
  include ::Rochambeau::Player
end
